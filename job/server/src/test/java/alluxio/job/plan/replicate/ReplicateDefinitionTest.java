...
@PrepareForTest({AlluxioBlockStoreClient.class, FileSystemContext.class, JobServerContext.class,
    BlockInStream.class})
public final class ReplicateDefinitionTest {
  ...
  public void before() throws Exception {
    ...
    when(AlluxioBlockStoreClient.create(mMockFileSystemContext)).thenReturn(mMockBlockStore);
  ...
  private void runTaskReplicateTestHelper(List<BlockWorkerInfo> blockWorkers,
    ...
    PowerMockito.mockStatic(AlluxioBlockStoreClient.class);
    when(AlluxioBlockStoreClient.create(any(FileSystemContext.class))).thenReturn(mMockBlockStore);
