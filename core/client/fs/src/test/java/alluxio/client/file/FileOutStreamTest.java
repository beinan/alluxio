...
@PrepareForTest({FileSystemContext.class, FileSystemMasterClient.class, AlluxioBlockStoreClient.class,
...
public class FileOutStreamTest {
  ...
  public void before() throws Exception {
    ...
    mBlockStore = PowerMockito.mock(AlluxioBlockStoreClient.class);
    mFileSystemMasterClient = PowerMockito.mock(FileSystemMasterClient.class);

    PowerMockito.mockStatic(AlluxioBlockStoreClient.class);
    PowerMockito.when(AlluxioBlockStoreClient.create(mFileSystemContext)).thenReturn(mBlockStore);
