...
public final class AlluxioFileInStreamTest {
  ...
  public void before() throws Exception {
    ...
    mBlockStore = mock(AlluxioBlockStoreClient.class);
    PowerMockito.mockStatic(AlluxioBlockStoreClient.class);
    PowerMockito.when(AlluxioBlockStoreClient.create(mContext)).thenReturn(mBlockStore);
  ...
  /**
   * Tests that {@link IOException}s thrown by the {@link AlluxioBlockStoreClient} are properly
   * propagated.
   */
  @Test
