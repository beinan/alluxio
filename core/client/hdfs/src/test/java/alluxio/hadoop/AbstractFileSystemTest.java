...
@PrepareForTest({AlluxioBlockStoreClient.class, FileSystemContext.class, FileSystemMasterClient.class,
...
public class AbstractFileSystemTest {
  ...
  void verifyBlockLocations(List<WorkerNetAddress> blockWorkers, List<String> ufsLocations,
    ...
    AlluxioBlockStoreClient blockStore = mock(AlluxioBlockStoreClient.class);
    PowerMockito.mockStatic(AlluxioBlockStoreClient.class);
    PowerMockito.when(AlluxioBlockStoreClient.create(any(FileSystemContext.class)))
